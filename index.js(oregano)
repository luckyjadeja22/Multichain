...
app.get('/api/somnia-stats', async (req, res) => {
    // Somnia is EVM compatible. Using Public Node RPC for Mainnet.
    // Alternate RPC if down: https://dream-rpc.somnia.network (Testnet/Devnet often uses this name, ensure chain ID matches)
